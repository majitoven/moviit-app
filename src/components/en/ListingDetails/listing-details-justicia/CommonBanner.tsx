   ...
   return (
      <div className="row">
         <div className="col-lg-6">
            <h3 className="property-titlee">Apartment found in Justicia for Paloma</h3>
            <div className="d-flex flex-wrap mt-10">
               ...
               <div className="address mt-15"><i className="bi bi-geo-alt"></i> Barrio Justicia, Central Madrid.
               </div>
               <p className="fs-20 lh-lg mt-10" style={{fontSize: '15px', marginTop: '20px'}}>Paloma arrived from Argentina directly to her apartment in Madrid to pursue a master's degree.</p>
