...
const SelectAmenities: React.FC<Props> = ({ register, errors, setValue, trigger, getValues }) => {
   const amenities = [
      "Air Conditioning", "Heating", "Balcony", "WiFi", "Elevator",
      "Garage", "Pets Allowed", "Bright", "Washing Machine/Laundry"
   ];
   ...
   return (
      <div className="bg-white card-box border-20 mt-40 md-m0">
         <h4 className="dash-title-three m0 pb-5">Amenities/Extras</h4>
