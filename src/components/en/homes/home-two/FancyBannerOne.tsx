                  ...
                  <div className="col-xl-8 col-lg-9 ms-auto wow fadeInRight">
                     <div className="ps-xxl-5">
                        <div className="title-one mb-50 lg-mb-30">
                           <h2 className="font-garamond fs-xl">We ensure the best match for you.</h2>
                        </div>
                        <div className="row">
                           ...
                           <div className="col-lg-8">
                              <p className="fs-24 color-dark" style={{marginBottom: '0px'}}><b>What is the cost of our service?</b> </p>
                              <p className="fs-20 color-dark">Our fee depends on the type of contract:</p>
