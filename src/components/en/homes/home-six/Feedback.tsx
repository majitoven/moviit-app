...
const feedback_data: DataType[] = [
  {
    ...
    blockquote: (
      <>
        Your <span>perfect space</span>, waiting for you.
      </>
    ),
    name: "Musa Delimuza",
    country: "Miami, USA",
  ...
  },
  {
    ...
    blockquote: (
      <>
        Arrive, sleep, and <span>enjoy.</span> We take care of everything.
      </>
    ),
    name: "Alina Cruse",
    country: "Miami, USA",
  ...
  },
  {
    ...
    blockquote: (
      <>
        Land <span>directly</span> in your new home
      </>
    ),
    name: "Musa Delimuza",
    country: "Rashed Ka.",
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="title-one mt-30 md-mb-50 pe-xxl-4 wow fadeInLeft">
                <h3>Madrid at your fingertips: your home awaits.</h3>
              </div>
            </div>
            <div className="col-lg-6">
