   ...
   return (
      <div className="row">
         <div className="col-lg-6">
            <h3 className="property-titlee">Piso encontrado en Bernabéu para
Lucía y Gastón</h3>
            <div className="d-flex flex-wrap mt-10">
               ...
               <p className="fs-20 lh-lg mt-10" style={{fontSize: '15px', marginTop: '20px'}}>Lucía y
               Gastón llegaron directamente a su apartamento en Madrid junto a sus perras, ya que vinieron a trabajar.
               </p>
