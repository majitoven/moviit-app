   ...
   return (
      <div className="row">
         <div className="col-lg-6">
            <h3 className="property-titlee">Piso encontrado en Justicia para Paloma </h3>
            <div className="d-flex flex-wrap mt-10">
               ...
               <div className="address mt-15"><i className="bi bi-geo-alt"></i> Barrio Justicia, Centro de Madrid.
               </div>
                     <p className="fs-20 lh-lg mt-10" style={{fontSize: '15px', marginTop: '20px'}}>Paloma llegó desde Argentina directamente a su apartamento en
                     Madrid para cursar un máster.</p>
            </div>
  
         </div>
         <div className="col-lg-6 text-lg-end">
            <div className="d-inline-block md-mt-40">
               <div className="price color-dark fw-500">Precio: €1650</div>
