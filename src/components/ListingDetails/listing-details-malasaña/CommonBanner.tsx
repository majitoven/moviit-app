   ...
   return (
      <div className="row">
         <div className="col-lg-6">
            <h3 className="property-titlee">Piso encontrado en Malasaña para Matías y Nicolás</h3>
            <div className="d-flex flex-wrap mt-10">
               ...
               <div className="address mt-15"><i className="bi bi-geo-alt"></i> Barrio Malasaña, Centro de Madrid.
               </div>
               <p className="fs-20 lh-lg mt-10" style={{fontSize: '15px', marginTop: '20px'}}>Matías y Nicolás llegaron desde Uruguay directamente a su apartamento en Madrid como parte de un programa de intercambio. </p>

            </div>
         </div>
         <div className="col-lg-6 text-lg-end">
            <div className="d-inline-block md-mt-40">
               <div className="price color-dark fw-500">Precio: €2200</div>
