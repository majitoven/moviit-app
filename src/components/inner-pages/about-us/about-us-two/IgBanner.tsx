               ...
               <div className="row align-items-end">
                  <div className="col-xl-6 col-lg-7 col-md-7">
                     <div className="pb-80 lg-pb-40">
                        <h3>Conoce todo sobre nosotros en <span className="fw-normal fst-italic">Instagram.</span></h3>
                        <div className="d-inline-flex flex-wrap align-items-center position-relative mt-15">
                           <Link href="/contact" className="btn-eight mt-10 me-4"><span>Contactanos</span></Link>
