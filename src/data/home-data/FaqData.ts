...
const faq_data:DataType[] = [
   {
      id: 1,
      page: "home_2_faq_1",
      question: "Contrato temporal (1 - 6 meses): 50% de 1 mes de alquiler",
   ...
   },
   {
      id: 2,
      page: "home_2_faq_1",
      question: "Contrato temporal (7 - 11 meses): 70% de 1 mes de alquiler",
      answer: "Seña de 200 Euros (1 persona)",
      showAnswer: false,
   },
   {
   ...
   },
   {
      ...
      answer: "En caso de ser más de 1 persona se requiere 200 Euros por persona de seña. Una vez firmado el contrato de alquiler se requiere el resto del monto restante.",
      showAnswer: false,
   },
