...
const faq_data:DataType[] = [
   ...
   },
   {
      ...
      answer: "En caso de ser más de 1 persona se requiere 200€ por persona de seña. Una vez firmado el contrato de alquiler se requiere el resto del monto restante.",
      showAnswer: false,
   },
